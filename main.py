...
class BattleshipGame:
    ...
    def computer_turn(self):
        ...
        if self.player_field.grid[y][x] == "P":
    ...
    def play(self):
        ...
        self.place_ships_randomly(self.computer_field, 5)
        self.computer_field.display()

        print("Расстановка ваших кораблей:")
        self.place_ships_randomly(self.player_field, 5)
